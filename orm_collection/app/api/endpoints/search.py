...
def trigger_search(source_type: str, keyword: str, db: Session = Depends(get_db)):
    ...
    execute_search_task.delay(source_type, keyword, dummy_keyword_id)
    return {"status": "queued", "source_type": source_type, "keyword": keyword}
